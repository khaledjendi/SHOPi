...
var Datastore = /** @class */ (function () {
    ...
    Datastore.prototype.newPersistentWriteStream = function () {
        return new persistent_stream_1.PersistentWriteStream(this.queue, this.connection, this.credentials, this.serializer);
    };
    Datastore.prototype.newPersistentWatchStream = function () {
        return new persistent_stream_1.PersistentListenStream(this.queue, this.connection, this.credentials, this.serializer);
    };
