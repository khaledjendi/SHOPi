...
var Service = /** @class */ (function () {
    ...
    function Service(app_, region_) {
        ...
        this.contextProvider = new context_1.ContextProvider(app_);
    }
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        response = _a.sent();
                        error = error_1._errorForResponse(response.status, response.json, this.serializer);
                        if (error) {
                            throw error;
                        }
                        if (!response.json) {
                            throw new error_1.HttpsErrorImpl('internal', 'Response is not valid JSON object.');
                        }
                        ...
                        if (typeof responseData === 'undefined') {
                            ...
                            throw new error_1.HttpsErrorImpl('internal', 'Response is missing data field.');
                        }
