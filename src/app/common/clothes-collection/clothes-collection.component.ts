...
export class ClothesCollectionComponent implements OnInit {
  ...
  constructor(private route: ActivatedRoute, private productService: ProductsService, private toastr: ToastrService, private router: Router, private db: AngularFireDatabase) {
  ...
  getProducts(type) {
    ...
    switch (type) {
      case "all":
        ...
        break;
      case "tops":
        this.getProductsCallByApi(CallOperator.TopsProducts);
        break;
      case "jeans":
        this.getProductsCallByApi(CallOperator.JeansProducts);
        break;
      case "t-shirts":
        this.getProductsCallByApi(CallOperator.TShirtProducts);
        break;
      case "skinny":
        this.getProductsCallByApi(CallOperator.SkinnyProducts);
        break;
      case "shirts":
        this.getProductsCallByApi(CallOperator.ShirtsProducts);
        break;
      case "regular":
        this.getProductsCallByApi(CallOperator.RegularProducts);
        break;
      case "polo shirts":
        this.getProductsCallByApi(CallOperator.PoloShirtsProducts);
        break;
      case "knitwear":
        this.getProductsCallByApi(CallOperator.KnitwearProducts);
        break;
    }
  ...
  private getProductsCallByApi(type: CallOperator) {
    this.startBlocking();
    this.productService.callAPI(type)
      .then(products => {
        this.loadProducts(products.data);
      })
      .catch(error => {
