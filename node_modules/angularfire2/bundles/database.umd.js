(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('angularfire2'), require('rxjs/Observable'), require('rxjs/operator/observeOn'), require('rxjs/add/operator/map'), require('rxjs/add/operator/delay'), require('rxjs/add/operator/share'), require('rxjs/add/operator/scan'), require('rxjs/add/observable/merge'), require('rxjs/add/observable/of'), require('rxjs/add/operator/switchMap'), require('rxjs/add/operator/filter'), require('rxjs/add/operator/distinctUntilChanged'), require('rxjs/add/operator/skipWhile'), require('rxjs/add/operator/withLatestFrom'), require('@firebase/database')) :
    typeof define === 'function' && define.amd ? define(['exports', '@angular/core', 'angularfire2', 'rxjs/Observable', 'rxjs/operator/observeOn', 'rxjs/add/operator/map', 'rxjs/add/operator/delay', 'rxjs/add/operator/share', 'rxjs/add/operator/scan', 'rxjs/add/observable/merge', 'rxjs/add/observable/of', 'rxjs/add/operator/switchMap', 'rxjs/add/operator/filter', 'rxjs/add/operator/distinctUntilChanged', 'rxjs/add/operator/skipWhile', 'rxjs/add/operator/withLatestFrom', '@firebase/database'], factory) :
    (factory((global.angularfire2 = global.angularfire2 || {}, global.angularfire2.database = global.angularfire2.database || {}),global.ng.core,global.angularfire2,global.Rx,global.Rx.Observable.prototype,global.Rx.Observable.prototype,global.Rx.Observable,global.Rx.Observable,global.Rx.Observable.prototype,global.Rx.Observable,global.Rx.Observable.prototype,global.Rx.Observable.prototype,global.Rx.Observable.prototype,global.Rx.Observable.prototype,global.Rx.Observable.prototype,global.Rx.Observable.prototype,global.firebase));
}(this, (function (exports,_angular_core,angularfire2,rxjs_Observable,rxjs_operator_observeOn,rxjs_add_operator_map,rxjs_add_operator_delay,rxjs_add_operator_share,rxjs_add_operator_scan,rxjs_add_observable_merge,rxjs_add_observable_of,rxjs_add_operator_switchMap,rxjs_add_operator_filter,rxjs_add_operator_distinctUntilChanged,rxjs_add_operator_skipWhile,rxjs_add_operator_withLatestFrom,_firebase_database) { 'use strict';
